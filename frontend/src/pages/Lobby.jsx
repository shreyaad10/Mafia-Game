...
export default function Lobby() {
  ...
  const { playerId, playerName, isHost, socket, setRoom } = useGame();
    ...
    <div className="page page-glow-gold">
      <div className="content-wide animate-fadeUp">
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <div
            className="room-code-display animate-scaleIn delay-2"
            onClick={copyCode}
            title="Click to copy"
          >
            {roomCode}
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '0.8rem', marginTop: '0.5rem', fontFamily: 'var(--font-heading)', letterSpacing: '0.2em' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: '1.25rem' }}>
          ...
          <div className="card animate-scaleIn delay-2">
            ...
            <div className="player-list">
              {players.map((p) => (
                <div
                  key={p._id}
                  className={`player-item ${p.isHost ? 'is-host' : ''}`}
                >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div className="card animate-scaleIn delay-4">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.9rem', color: 'var(--text-dim)', fontStyle: 'italic' }}>
...
function getRolePreview(count) {
  if (count < 2) return [{ role: 'God', count: 1 }];
